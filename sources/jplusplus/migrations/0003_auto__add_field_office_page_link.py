...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Office.page_link'
        db.add_column(u'jplusplus_office', 'page_link',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Page'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Office.page_link'
        db.delete_column(u'jplusplus_office', 'page_link_id')
