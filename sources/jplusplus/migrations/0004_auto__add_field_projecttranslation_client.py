...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectTranslation.client'
        db.add_column(u'jplusplus_project_translation', 'client',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectTranslation.client'
        db.delete_column(u'jplusplus_project_translation', 'client')
