...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TrombinoscopeTranslation.short_description'
        db.alter_column(u'jplusplus_trombinoscope_translation', 'short_description', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'TrombinoscopeTranslation.short_description'
        db.alter_column(u'jplusplus_trombinoscope_translation', 'short_description', self.gf('django.db.models.fields.CharField')(max_length=20))
