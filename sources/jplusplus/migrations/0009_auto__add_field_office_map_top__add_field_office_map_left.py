...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Office.map_top'
        db.add_column(u'jplusplus_office', 'map_top',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Office.map_left'
        db.add_column(u'jplusplus_office', 'map_left',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Office.map_top'
        db.delete_column(u'jplusplus_office', 'map_top')

        # Deleting field 'Office.map_left'
        db.delete_column(u'jplusplus_office', 'map_left')
