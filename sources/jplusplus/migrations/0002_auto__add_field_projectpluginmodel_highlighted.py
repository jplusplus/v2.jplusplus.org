...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectPluginModel.highlighted'
        db.add_column(u'jplusplus_projectpluginmodel', 'highlighted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectPluginModel.highlighted'
        db.delete_column(u'jplusplus_projectpluginmodel', 'highlighted')
