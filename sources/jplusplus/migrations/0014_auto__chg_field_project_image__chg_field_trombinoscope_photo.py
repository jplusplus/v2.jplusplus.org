...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'jplusplus_project', 'image', self.gf('jplusplus.fields.ImageWithThumbsField')(max_length=100))

        # Changing field 'Trombinoscope.photo'
        db.alter_column(u'jplusplus_trombinoscope', 'photo', self.gf('jplusplus.fields.ImageWithThumbsField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Project.image'
        db.alter_column(u'jplusplus_project', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

        # Changing field 'Trombinoscope.photo'
        db.alter_column(u'jplusplus_trombinoscope', 'photo', self.gf('django.db.models.fields.files.ImageField')(max_length=255))
    ...
    models = {
        ...
        u'jplusplus.project': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('jplusplus.fields.ImageWithThumbsField', [], {'max_length': '100'}),
        ...
        u'jplusplus.trombinoscope': {
            ...
            'offices': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['jplusplus.Office']", 'symmetrical': 'False'}),
            'photo': ('jplusplus.fields.ImageWithThumbsField', [], {'max_length': '255'}),
