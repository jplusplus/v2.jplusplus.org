...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProjectTranslation.description'
        db.alter_column(u'jplusplus_project_translation', 'description', self.gf('djangocms_text_ckeditor.fields.HTMLField')(null=True))

    def backwards(self, orm):

        # Changing field 'ProjectTranslation.description'
        db.alter_column(u'jplusplus_project_translation', 'description', self.gf('django.db.models.fields.TextField')(null=True))
