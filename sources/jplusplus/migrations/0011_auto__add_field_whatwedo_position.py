...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WhatWeDo.position'
        db.add_column(u'jplusplus_whatwedo', 'position',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WhatWeDo.position'
        db.delete_column(u'jplusplus_whatwedo', 'position')
